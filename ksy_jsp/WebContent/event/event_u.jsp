<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*,dao.Event_DAO,dto.Event_DTO,common.CommonUtil"%>
...
%>
		...
		<div class="notice">
			<div class="sub-notice">
				<h2><span><i class="fas fa-edit"></i> EVENT-Modify</span></h2>	
			</div>
					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td><input type="date" value="20<%=dto.getStart_date()%>" id="title" name ="t_startDate" class="title"></td>
								<th><label for="file">End Date</label></th>
								<td><input type="date" value="20<%=dto.getEnd_date()%>" name ="t_colseDate" id="title" class="title"></td>
							</tr>
							...
							<tr>
								...
								<input type="hidden" name="t_work_gubun" value ="up">
