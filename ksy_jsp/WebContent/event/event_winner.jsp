...
<%	if ( total_count > 0 ){
	...
	int dang = dao.Kakunin2(userId,dtos.get(k).getEvent_no());		
	EventM_DTO dto = dao.getWinnerName(dtos.get(k).getEvent_no());		
%>				<a href="event_v.jsp">
...
<%if(dto != null){
%>		
						<td style="color:red"><%=dto.getName()%></td>
