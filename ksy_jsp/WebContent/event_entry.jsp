...
<%
	EventEntry_DTO dto_1= new EventEntry_DTO("E_19001","응모합니다.1~~~","홍길동","y");
	EventEntry_DTO dto_2= new EventEntry_DTO("E_19002","응모합니다.2~~~","이상은","n");
	EventEntry_DTO dto_3= new EventEntry_DTO("E_19003","응모합니다.3~~~","김정은","y");
...
%>					 
			...
			<div class="page-number">
				...
				<a href="javascript:eventProc()" class="btn-write">글쓰기</a>
			</div>
