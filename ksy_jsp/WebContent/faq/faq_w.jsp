					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td><input type="text" name="t_title" id="title" class="title" placeholder="must write title"></td>
								<input type="hidden" name="t_work"  value ="insert">
							</tr>
							
							<tr>
								<th><label for="cont">Content</label></th>
								<td><textarea type="cont" name="t_content" id="cont" class="cont" placeholder="must write Content"></textarea>
							</tr>
