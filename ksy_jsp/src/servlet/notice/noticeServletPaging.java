...
/**
 * Servlet implementation class noticeServletPaging
 */
@WebServlet("/noticeServletPaging")
public class noticeServletPaging extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public noticeServletPaging() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//******** page 시작 *******/
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/notice/notice_r3.jsp");
