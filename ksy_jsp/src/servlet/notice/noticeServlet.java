...
public class noticeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("t_tdCount",tdCount);
		request.setAttribute("t_total_count",total_count);
		request.setAttribute("t_for_count",for_count);
		request.setAttribute("t_v_count",v_count);
		request.setAttribute("t_a_count",a_count);
